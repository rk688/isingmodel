...
// Parameter für Q-Fit Funktionen
...
int main(){
        ...
        //schreibe Kopf von neuem Daten-File
        ...
        //vectoren zum Speichern der Messwerte
        vector<double> betas(number_of_configurations);
        Auswertung binder; // hier eigene Klasse mit Eigenschaften siehe analyse.h
        Auswertung sus1;
        Auswertung sus2;
        Auswertung korel;
        ...
        string zeile;
        int counter=0; // counter zum Zählen der Anzahl an Messwerten
